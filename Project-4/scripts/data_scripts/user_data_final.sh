...
wp config create --dbname=wordpress --dbuser=wp_user --dbpass=wp_pass --dbhost=10\.0\.1\.88 --allow-root
...
wp option update home 'http://BenchmarkALB-908744920\.us-east-1\.elb\.amazonaws\.com' --allow-root
wp option update siteurl 'http://BenchmarkALB-908744920\.us-east-1\.elb\.amazonaws\.com' --allow-root
